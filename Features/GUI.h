	...
	void NewGui()
	{
		...
		ImGui::Begin("CS2", nullptr, Flags);
		{
			...
			if (MenuConfig::SafeMode)
				ImGui::TextColored(ImColor(255, 255, 255, 200), "Safe Mode: On");
			else
				ImGui::TextColored(ImColor(255, 25, 0, 200), "Safe Mode: Off");
			...
			ImGui::BeginChild("Page", MenuConfig::WCS.ChildSize);
			{
				...
				if (MenuConfig::WCS.MenuPage == 1)
				{
					...
					if (MenuConfig::AimBot)
					{
						...
						*/
						...
						ImGui::SetCursorScreenPos(ImVec2(StartPos.x + 50, StartPos.y + 42));
						ImGui::Image((void*)HitboxImage, ImVec2(137, 320));
				...
				if (MenuConfig::WCS.MenuPage == 2)
				{
					...
					ImGui::SameLine();
					if (ImGui::Combo("###Theme", &MenuConfig::Theme, "Default\0CS2 Cheats\0Custom\0"))
					...
					ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 5.f);
					if (ImGui::Button("Website", { ImGui::GetColumnWidth() - 20.f, 25.f }))
						Gui.OpenWebpage("https://tdcheats.com");
					ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 5.f);
					if (ImGui::Button(ICON_FA_COMMENT_DOTS " Join Discord", { ImGui::GetColumnWidth() - 20.f, 25.f }))
						Gui.OpenWebpage("https://tdcheats.com/discord");
